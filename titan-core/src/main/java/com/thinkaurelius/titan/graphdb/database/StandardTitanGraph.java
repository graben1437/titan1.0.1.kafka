...
public class StandardTitanGraph extends TitanBlueprintsGraph {
    ...
    private boolean logAllChanges = false;
...
//    }
    ...
    public void commit(final Collection<InternalRelation> addedRelations,
        ...
        // BECAUSE of this line right here...KCVSLog is not truly pluggable...even though it has interfaces that
        // attempt to make it pluggable
